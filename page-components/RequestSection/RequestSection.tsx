...
const RequestSection: FC = () => {
  ...
  return (
    <div id={navigationSection.request}>
      <Sections className="bg-blueBg ">
        <div className="container xl:relative xl:pt-[86px]">
          <div className="w-full rounded rounded-br-[60px] bg-blueBgGradient text-whiteBg shadow-primaryShadow xl:px-[104px] xl:py-10 smOnly:flex-col smOnly:items-center smOnly:px-4 smOnly:pt-4 mdOnly:justify-between mdOnly:pl-10 mdOnly:pr-5 mdOnly:pt-10 notXl:flex">
